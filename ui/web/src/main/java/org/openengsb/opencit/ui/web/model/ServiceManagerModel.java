...
public class ServiceManagerModel extends LoadableDetachableModel<ServiceManager> {
    ...
    public ServiceManagerModel(String descriptor, ManagerMapModel managerMapModel) {
        this.descriptor = descriptor;
        this.managerMapModel = managerMapModel;
    }

    @Override
    protected ServiceManager load() {
        return managerMapModel.getObject().get(descriptor);
    }
